      ...
      <table className="w-full table-fixed border border-black/10">
        <thead>
          <tr>
            ...
            <th className=" px-4 py-4 border bg-logoblue text-white font-semibold w-80">Info</th>
          ...
          {users.map((u) => {
            ...
            return (
              <tr key={u.id} onClick={() => onRowClick(u)} className={`cursor-pointer border-b border-black/10 hover:bg-black/2 ${rowMuted}`} >
                ...
                <td className=" px-2 py-2 align-top"><div className="max-h-12 overflow-y-auto pr-2 whitespace-break-spaces">{u.info}</div></td>
