        ...
        <div className="w-full lg:flex-1 flex flex-col justify-center">
          <form>
            <div className="bg-logoblue rounded-2xl p-6 max-w-[480] mx-auto">
              ...
              <div className="mb-4">
                <label className="block pb-1 text-lg text-white font-semibold">
              ...
              <div className="flex pt-4">
                <button className="customButtonEnabled bg-white! text-logoblue! font-semibold! w-full max-w-[400] mx-auto h-10">
