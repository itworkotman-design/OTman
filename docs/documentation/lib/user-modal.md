...
Defines the user-modal prop and form shape plus the small helper functions that build, derive, and update modal state for both direct-password and invite-based user creation.

## Functions

| Function | Description |
| --- | --- |
| `buildInitialForm` | Creates the modal form state from the provided initial values, including the optional address field, sidebar appearance fields, default direct-create mode, and empty password fields. |
