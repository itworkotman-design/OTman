...
| `getEffectiveArchiveCustomerTotal` | Calculates the customer-facing archive total from stored price, discount, and add-on fields, or from protected fee lines for cancelled rows without a stored discount. |
