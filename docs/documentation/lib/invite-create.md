...
| `createInvite` | Validates actor access, revokes prior pending invites for the same email, creates a new invite, saves the optional address with the rest of the seeded profile data, delivers the invite, and logs `INVITE_SENT`. |
