...
Reads and updates a single order, including product-card snapshots, event snapshots, order-item rebuilding, and extra-pickup alert creation when extra pickups change.
