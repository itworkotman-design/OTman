...
| `getNativeCalculatedPricing` | Rebuilds the native ex-VAT and subcontractor totals from mapped product cards, the current booking catalog, imported admin adjustment fields, and imported hardcoded fee fields. |
