...
| --- | --- |
| `AddressAutocompleteInput` | Main React component for the shared autocomplete input. Manages query state, loading state, dropdown visibility, and selection behavior. |
