...
const ARCHIVE_UI_HISTORY_EVENT_LABELS: Readonly<Record<ArchiveEventAction, string>> = {
  ...
  "archive.folder.renamed": "Folder renamed",
  "archive.folder.moved": "Folder moved",
  "archive.folder.owner_changed": "Folder owner changed",
  "archive.folder.tag_added": "Folder tag added",
  "archive.folder.tag_removed": "Folder tag removed",
  ...
  "archive.item.renamed": "Item renamed",
  "archive.item.moved": "Item moved",
  "archive.item.owner_changed": "Item owner changed",
  "archive.item.tag_added": "Item tag added",
  "archive.item.tag_removed": "Item tag removed",
