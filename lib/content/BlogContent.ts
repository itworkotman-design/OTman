...
export const blogPageContent = {
  ...
  intro: {
    en: "Read practical updates, delivery guidance, and behind-the-scenes notes from the Otman AS team. This page is ready for the dashboard blog editor that will be added later.",
    no: "Les praktiske oppdateringer, leveringsråd og korte innblikk fra Otman AS-teamet. Siden er klar for bloggadministrasjonen som kommer senere.",
  },
  searchLabel: {
    en: "Search blogs",
    no: "Søk i blogg",
